  ...
  <body>
    ...
    <div class="x-body">
      <div class="layui-row" style="" align="center">
        <form class="layui-form layui-col-md12 x-so" method="get" action="${ctx }/dept/selectDept" id="deptForm">
...
<%--            </select>--%>
     ...
     <tr>
            ...
            <td class="td-manage">
              ...
              <a title="编辑"  onclick="x_admin_show('编辑','${ctx}/dept/addDept?id=${dept.id }');" href="javascript:;">
    ...
    <script type="text/javascript">
        ...
        $("#pagerJump").click(function(){
            ...
            }else
            {
                ...
                $("#deptForm").attr("action", "${ctx}/dept/listDept");
                $("#deptForm").submit();
            }
        })
    </script>
