...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="deptForm"  action="${ctx}/dept/editDept">
...
<%--                </label>--%>
<%--                <div class="layui-input-inline">--%>
<%--                    <input type="file" id="logo" name="logo" accept="image/*" οnchange="uploadLogo()" >--%>
<%--                </div>--%>
<%--          </div>--%>
<%--            <div class="showimg" style="width: 100px;height: 100px;background-color: #c0c0c0;margin-left: 100px;margin-bottom: 15px;">--%>
<%--                <img id="img" src="${ctx}/public/images/cc.jpg" alt="">--%>
<%--            </div>--%>
          <div class="layui-form-item">
