...
<html>
  ...
  <body>
    <div class="x-nav">
      ...
      <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${ctx }/user/listUser" title="刷新">
        <i class="layui-icon" style="line-height:30px">ဂ</i></a>
    </div>
    <div class="x-body">
      <div class="layui-row" style="" align="center">
        <form class="layui-form layui-col-md12 x-so" method="get" action="${ctx }/user/selectUser" id="userform">
     ...
     <tr>
            ...
            <td class="td-manage">
              ...
              <a title="编辑"  href="${ctx}/user/addUser?id=${user.id }">
    ...
    <script type="text/javascript">
        ...
        $("#query").click(function(){
            ...
            $("#userform").attr("action", "${ctx}/user/selectUser");
            $("#userform").submit();
        })
        $("#pagerJump").click(function(){
            ...
            }else
            {
                ...
                $("#userform").attr("action", "${ctx}/user/listUser");
                $("#userform").submit();
            }
        })
    </script>
