...
<html>
  ...
  <body>
    <div class="x-body">
        <form class="layui-form" method="POST" id="documentForm" enctype="multipart/form-data" action="${ctx}/document/editDocument">
        <input type="hidden" name="id" id="id" value="${document.id }" >
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${document.title }">
              </div>
        ...
        <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${document.remark }">
              </div>
